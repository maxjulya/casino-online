<?php
/**
 * Template name: Casino List Template
 */
                        ...
                        <div class="casino_block">
                            ...
                            <div class="casino_block_left">
                                ...
                                <div class="casino_block_image">
                                    <picture>
                                        <?php echo get_the_post_thumbnail(get_the_ID(), 'casino_list_height'); ?>
                                    </picture>
                                </div>
                            ...
                            <div class="casino_block_right">
                                ...
                                <a href="<?php the_permalink(); ?>" class=" casino_block_button button_popular
                                   button--reverse">
