...
jQuery(document).ready(function ($) {
	 ...
	 */
	$('.oc_upload_file').change(function () {
		formfield = $(this).attr('name');
		$('#' + formfield + '_id').val("");
	});

	$('.oc_upload_button').on('click', function () {
		var buttonLabel;
	...
	$('.oc_remove_file_button').on('click', function () {
