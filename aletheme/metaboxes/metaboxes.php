...
{
	if (!function_exists('ale_metaboxes')) {
		return;
	}
	
	add_filter('ale_meta_boxes', 'ale_metaboxes' );
...
class Ale_Meta_Box {
	...
	function __construct( $meta_box ) {
		...
		add_filter( 'ale_show_on', array( &$this, 'ale_add_for_page_template' ), 10, 2 );
	}
	...
	function ale_add_for_page_template( $display, $meta_box ) {
	...
	function show() {
		...
		foreach ( $this->_meta_box['fields'] as $field ) {
			...
			switch ( $field['type'] ) {
				...
				case 'text':
					echo '<input type="text" name="', esc_attr($field['id']), '" id="', esc_attr($field['id']), '" value="', '' !== $meta ? $meta : esc_attr($field['std']), '" />','<p class="ale_metabox_description">', esc_attr($field['desc']), '</p>';
					break;
				case 'text_small':
					echo '<input class="ale_text_small" type="text" name="', esc_attr($field['id']), '" id="', esc_attr($field['id']), '" value="', '' !== $meta ? $meta : esc_attr($field['std']), '" /><span class="ale_metabox_description">', esc_attr($field['desc']), '</span>';
					break;
				case 'text_medium':
					echo '<input class="ale_text_medium" type="text" name="', esc_attr($field['id']), '" id="', esc_attr($field['id']), '" value="', '' !== $meta ? $meta : esc_attr($field['std']), '" /><span class="ale_metabox_description">', esc_attr($field['desc']), '</span>';
					break;
				case 'text_date':
					echo '<input class="ale_text_small ale_datepicker" type="text" name="', esc_attr($field['id']), '" id="', esc_attr($field['id']), '" value="', '' !== $meta ? $meta : esc_attr($field['std']), '" /><span class="ale_metabox_description">', esc_attr($field['desc']), '</span>';
					break;
				case 'text_date_timestamp':
					echo '<input class="ale_text_small ale_datepicker" type="text" name="', esc_attr($field['id']), '" id="', esc_attr($field['id']), '" value="', '' !== $meta ? date( 'm\/d\/Y', $meta ) : esc_attr($field['std']), '" /><span class="ale_metabox_description">', esc_attr($field['desc']), '</span>';
					break;
				case 'text_datetime_timestamp':
					echo '<input class="ale_text_small ale_datepicker" type="text" name="', esc_attr($field['id']), '[date]" id="', esc_attr($field['id']), '_date" value="', '' !== $meta ? date( 'm\/d\/Y', $meta ) : esc_attr($field['std']), '" />';
					echo '<input class="ale_timepicker text_time" type="text" name="', esc_attr($field['id']), '[time]" id="', esc_attr($field['id']), '_time" value="', '' !== $meta ? date( 'h:i A', $meta ) : esc_attr($field['std']), '" /><span class="ale_metabox_description" >', esc_attr($field['desc']), '</span>';
					break;
				case 'text_time':
					echo '<input class="ale_timepicker text_time" type="text" name="', esc_attr($field['id']), '" id="', esc_attr($field['id']), '" value="', '' !== $meta ? $meta : esc_attr($field['std']), '" /><span class="ale_metabox_description">', esc_attr($field['desc']), '</span>';
					break;					
				case 'text_money':
					echo '$ <input class="ale_text_money" type="text" name="', esc_attr($field['id']), '" id="', esc_attr($field['id']), '" value="', '' !== $meta ? $meta : esc_attr($field['std']), '" /><span class="ale_metabox_description">', esc_attr($field['desc']), '</span>';
					break;
				case 'colorpicker':
					...
					echo '<input class="ale_colorpicker ale_text_small" name="' . esc_attr($field['id']) . '" id="' . esc_attr($field['id']) . '" type="text" value="', '' !== $meta ? $meta : esc_attr($field['std']), '" />';
					break;
				case 'textarea':
					echo '<textarea name="', esc_attr($field['id']), '" id="', esc_attr($field['id']), '" cols="60" rows="10">', '' !== $meta ? $meta : esc_attr($field['std']), '</textarea>','<p class="ale_metabox_description">', esc_attr($field['desc']), '</p>';
					break;
				case 'textarea_small':
					echo '<textarea name="', esc_attr($field['id']), '" id="', esc_attr($field['id']), '" cols="60" rows="4">', '' !== $meta ? $meta : esc_attr($field['std']), '</textarea>','<p class="ale_metabox_description">', esc_attr($field['desc']), '</p>';
					break;
				case 'textarea_code':
					echo '<textarea name="', esc_attr($field['id']), '" id="', esc_attr($field['id']), '" cols="60" rows="10" class="ale_textarea_code">', '' !== $meta ? $meta : $field['std'], '</textarea>','<p class="ale_metabox_description">', esc_attr($field['desc']), '</p>';
					break;					
				case 'select':
					...
					echo '</select>';
					echo '<p class="ale_metabox_description">', esc_attr($field['desc']), '</p>';
					break;
				...
				case 'radio_inline':
					...
					$i = 1;
					foreach ($field['options'] as $option) {
						echo '<div class="ale_radio_inline_option"><input type="radio" name="', esc_attr($field['id']), '" id="', esc_attr($field['id']), $i, '" value="', esc_attr($option['value']), '"', $meta == $option['value'] ? ' checked="checked"' : '', ' /><label for="', esc_attr($field['id']), $i, '">', esc_attr($option['name']), '</label></div>';
						$i++;
					}
					echo '</div>';
					echo '<p class="ale_metabox_description">', esc_attr($field['desc']), '</p>';
				...
				case 'checkbox':
					...
					echo '<span class="ale_metabox_description">', esc_attr($field['desc']), '</span>';
					break;
				case 'multicheck':
					echo '<ul>';
					$i = 1;
					...
					break;		
				case 'title':
					echo '<h5 class="ale_metabox_title">', esc_attr($field['name']), '</h5>';
					echo '<p class="ale_metabox_description">', esc_attr($field['desc']), '</p>';
					break;
				case 'wysiwyg':
				...
				break;
				case 'file_list':
					echo '<input class="ale_upload_file" type="text" size="36" name="', esc_attr($field['id']), '" value="" />';
				...
				case 'file':
					...
					if ( 'url' == $field['allow'] || ( is_array( $field['allow'] ) && in_array( 'url', $field['allow'] ) ) )
						$input_type_url="text";
					echo '<input class="ale_upload_file" type="' . esc_attr($input_type_url). '" size="45" id="', esc_attr($field['id']), '" name="', esc_attr($field['id']), '" value="', esc_attr($meta), '" />';
					echo '<input class="ale_upload_button button" type="button" value="Upload File" />';
					echo '<input class="ale_upload_file_id" type="hidden" id="', esc_attr($field['id']), '_id" name="', esc_attr($field['id']), '_id" value="', get_post_meta( $post->ID, esc_attr($field['id']) . "_id",true), '" />';
					echo '<p class="ale_metabox_description">', esc_attr($field['desc']), '</p>';
					echo '<div id="', esc_attr($field['id']), '_status" class="ale_upload_status">';
						if ( $meta != '' ) { 
							$check_image = preg_match( '/(^.*\.jpg|jpeg|png|gif|ico*)/i', $meta );
							if ( $check_image ) {
								echo '<div class="img_status">';
								echo '<img src="', esc_url($meta), '" alt="" />';
								echo '<a href="#" class="ale_remove_file_button" rel="', esc_attr($field['id']), '">Remove Image</a>';
								echo '</div>';
							} else {
								$parts = explode( '/', $meta );
								...
								echo 'File: <strong>', esc_attr($title), '</strong>&nbsp;&nbsp;&nbsp; (<a href="', esc_url($meta), '" target="_blank" rel="external">Download</a> / <a href="#" class="ale_remove_file_button" rel="', esc_attr($field['id']), '">Remove</a>)';
							}	
						}
					echo '</div>'; 
				break;
