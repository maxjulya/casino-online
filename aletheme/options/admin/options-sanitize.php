...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__('No Repeat', 'gardener'),
		'repeat-x'  => esc_html__('Repeat Horizontally', 'gardener'),
		'repeat-y'  => esc_html__('Repeat Vertically', 'gardener'),
		'repeat'    => esc_html__('Repeat All', 'gardener'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__('Top Left', 'gardener'),
		'top center'    => esc_html__('Top Center', 'gardener'),
		'top right'     => esc_html__('Top Right', 'gardener'),
		'center left'   => esc_html__('Middle Left', 'gardener'),
		'center center' => esc_html__('Middle Center', 'gardener'),
		'center right'  => esc_html__('Middle Right', 'gardener'),
		'bottom left'   => esc_html__('Bottom Left', 'gardener'),
		'bottom center' => esc_html__('Bottom Center', 'gardener'),
		'bottom right'  => esc_html__('Bottom Right', 'gardener')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__('Scroll Normally', 'gardener'),
		'fixed'  => esc_html__('Fixed in Place', 'gardener')
		);
...
function of_recognized_background_size() {
	$default = array(
		'auto' => esc_html__('Auto', 'gardener'),
		'cover'  => esc_html__('Cover', 'gardener'),
		'contain'  => esc_html__('Contain', 'gardener'),
		'initial'  => esc_html__('Initial', 'gardener'),
...
function of_recognized_menu_text_align() {
	$default = array(
		'left' => esc_html__('Left', 'gardener'),
		'center'  => esc_html__('Center', 'gardener'),
		'right'  => esc_html__('Right', 'gardener'),
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__('Normal', 'gardener'),
		'italic'      => esc_html__('Italic', 'gardener'),
		'bold'        => esc_html__('Bold', 'gardener'),
		'bold italic' => esc_html__('Bold Italic', 'gardener')
		);
...
function of_recognized_font_transform() {
	$default = array(
		'none'      => esc_html__('None', 'gardener'),
		'capitalize'      => esc_html__('Capitalize', 'gardener'),
		'uppercase'        => esc_html__('Uppercase', 'gardener'),
		'lowercase' => esc_html__('Lowercase', 'gardener')
	);
	return apply_filters( 'of_recognized_font_styles', $default );
}
...
function of_recognized_font_weight() {
	$default = array(
		'200' => esc_html__('Extra-Light 200', 'gardener'),
		'300' => esc_html__('Light 300', 'gardener'),
		'400' => esc_html__('Regular 400', 'gardener'),
		'500' => esc_html__('Medium 500', 'gardener'),
		'600' => esc_html__('Semi-Bold 600', 'gardener'),
		'700' => esc_html__('Bold 700', 'gardener'),
		'800' => esc_html__('Extra-Bold 800', 'gardener'),
		'900' => esc_html__('Ultra-bold 900', 'gardener')
	);
